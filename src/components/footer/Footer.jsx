...
import {footerNav, footerLegal, footerSocial} from './footer.constants.js'
...
const Footer = () => {
  ...
  <p className="text-sm opacity-80 leading-relaxed">
    Shop the latest products across electronics, fashion, and more — fast and easy.
  </p>

  <div className="text-sm opacity-70">
    <p>ORBIT Store Pvt. Ltd.</p>
    <p>MG Road, Bengaluru</p>
    <p>Karnataka, India</p>
  </div>

  <p className="text-xs opacity-60 mt-2">
    © {new Date().getFullYear()} ORBIT Store. All rights reserved.
  </p>
</div>
      ...
      <div className="border-t border-[var(--border-color)] px-6 py-4">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 text-xs opacity-70 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="opacity-60">Powered by ORBIT</span>
          </div>
        </div>
      </div>
    </footer>
